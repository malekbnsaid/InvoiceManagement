...
namespace InvoiceManagement.Server.Migrations
{
    ...
    [Migration("20250811083216_AddDocumentVersioningAndStorage")]
    partial class AddDocumentVersioningAndStorage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceManagement.Server.Domain.Entities.DocumentMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DocumentQuality")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OcrConfidence")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InvoiceManagement.Server.Domain.Entities.DocumentStorage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AccessControlList")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("DocumentStorages");
                });

            modelBuilder.Entity("InvoiceManagement.Server.Domain.Entities.DocumentVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DocumentAttachmentId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DocumentAttachmentId1")
                        .IsUnique()
                        .HasFilter("[DocumentAttachmentId1] IS NOT NULL");
            ...
            modelBuilder.Entity("InvoiceManagement.Server.Domain.Entities.DocumentMetadata", b =>
                {
                    b.HasOne("InvoiceManagement.Server.Domain.Entities.DocumentAttachment", "DocumentAttachment")
                        .WithOne("Metadata")
                        .HasForeignKey("InvoiceManagement.Server.Domain.Entities.DocumentMetadata", "DocumentAttachmentId")
            ...
            modelBuilder.Entity("InvoiceManagement.Server.Domain.Entities.DocumentVersion", b =>
                {
                    ...
                    b.HasOne("InvoiceManagement.Server.Domain.Entities.DocumentAttachment", null)
                        .WithOne("CurrentVersion")
                        .HasForeignKey("InvoiceManagement.Server.Domain.Entities.DocumentVersion", "DocumentAttachmentId1");
